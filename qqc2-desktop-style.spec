...
Version  : 6.12.0
Release  : 281
URL      : https://download.kde.org/stable/frameworks/6.12/qqc2-desktop-style-6.12.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.12/qqc2-desktop-style-6.12.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.12/qqc2-desktop-style-6.12.0.tar.xz.sig
...
%setup -q -n qqc2-desktop-style-6.12.0
cd %{_builddir}/qqc2-desktop-style-6.12.0
pushd ..
cp -a qqc2-desktop-style-6.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742530533
mkdir -p clr-build
pushd clr-build
