...
Source0  : https://download.kde.org/stable/frameworks/5.68/qqc2-desktop-style-5.68.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.68/qqc2-desktop-style-5.68.0.tar.xz.sig
...
%prep
%setup -q -n qqc2-desktop-style-5.68.0
cd %{_builddir}/qqc2-desktop-style-5.68.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584425743
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/qqc2-desktop-style-5.68.0/LICENSE.GPL-2 %{buildroot}/usr/share/package-licenses/qqc2-desktop-style/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/qqc2-desktop-style-5.68.0/LICENSE.LGPL-3 %{buildroot}/usr/share/package-licenses/qqc2-desktop-style/4b9b50cade3fd0958dc5ef57317ff9129ce2d3cb
pushd clr-build
%make_install
popd
