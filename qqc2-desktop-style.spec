...
Source0  : https://download.kde.org/stable/frameworks/5.55/qqc2-desktop-style-5.55.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.55/qqc2-desktop-style-5.55.0.tar.xz.sig
...
%prep
%setup -q -n qqc2-desktop-style-5.55.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1549767399
mkdir -p clr-build
pushd clr-build
%cmake ..
