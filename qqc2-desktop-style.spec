...
Version  : 5.108.0
Release  : 224
URL      : https://download.kde.org/stable/frameworks/5.108/qqc2-desktop-style-5.108.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.108/qqc2-desktop-style-5.108.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.108/qqc2-desktop-style-5.108.0.tar.xz.sig
...
%prep
%setup -q -n qqc2-desktop-style-5.108.0
cd %{_builddir}/qqc2-desktop-style-5.108.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1689018984
mkdir -p clr-build
pushd clr-build
