...
Source0  : https://download.kde.org/stable/frameworks/6.13/qqc2-desktop-style-6.13.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.13/qqc2-desktop-style-6.13.0.tar.xz.sig
...
%setup -q -n qqc2-desktop-style-6.13.0
cd %{_builddir}/qqc2-desktop-style-6.13.0
pushd ..
cp -a qqc2-desktop-style-6.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744661334
mkdir -p clr-build
pushd clr-build
