...
Source0  : https://download.kde.org/stable/frameworks/5.99/qqc2-desktop-style-5.99.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.99/qqc2-desktop-style-5.99.0.tar.xz.sig
...
%prep
%setup -q -n qqc2-desktop-style-5.99.0
cd %{_builddir}/qqc2-desktop-style-5.99.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667935405
mkdir -p clr-build
pushd clr-build
