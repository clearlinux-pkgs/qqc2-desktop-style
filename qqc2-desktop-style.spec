...
Version  : 6.14.0
Release  : 283
URL      : https://download.kde.org/stable/frameworks/6.14/qqc2-desktop-style-6.14.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.14/qqc2-desktop-style-6.14.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.14/qqc2-desktop-style-6.14.0.tar.xz.sig
...
%setup -q -n qqc2-desktop-style-6.14.0
cd %{_builddir}/qqc2-desktop-style-6.14.0
pushd ..
cp -a qqc2-desktop-style-6.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747174559
mkdir -p clr-build
pushd clr-build
